...
Run with the rest of the suite:
    python -m pytest tests/unit/test_verify_index.py
...
from thesis.corpus_build.qc import verify_index as vi
...
class VerifyIndex(unittest.TestCase):
    ...
    def test_missing_artifact_is_caught(self):
        ...
        self.assertIn("run thesis.corpus_build.embedding.embed_chunks first", output.lower())
