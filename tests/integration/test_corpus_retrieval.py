...
Run with the rest of the suite:
    python -m pytest tests/integration/test_corpus_retrieval.py
...
from thesis.corpus_build.embedding import embed_chunks as ec
from thesis.corpus_build.indexing import retrieve as rt
