...
class CorpusSection:
    ...
    chunks_path: str = "data/pmc/chunks/chunks.jsonl"
    chunk_stats_path: str = "data/pmc/chunks/chunk_stats.json"
    index_dir: str = "data/pmc/index"
...
class RetrievalSection:
    ...
    final_top_k: int = 8
    rerank: bool = True
    candidates_dir: str = "data/pmc/candidates"
...
class RecencySection:
    ...
    implemented here -- see src/thesis/recency.py.
    """
