...
Specification** (M1–M4). Built by `thesis.corpus_build.metadata.build_corpus_metadata`.
...
python -m thesis.corpus_build.metadata.build_corpus_metadata
...
python -m thesis.corpus_build.metadata.build_corpus_metadata --pubmed <path-to-pubmed_results.csv> --no-fetch
```
